<div id="sobre" class="page-alternate">
    <div class="container">
        <!-- Title Page -->
        <div class="row">
            <div class="span12">
                <div class="title-page">
                    <h2 class="title">Elder Xavier</h2>
        ...
        <div class="row">
            ...
            <div class="span4 profile">                
                <p class="profile-description">Desenvolvimento de softwares é coisa seria.
                    Um código limpo e de qualidade é impressindivel para a elaboração de qualquer projeto, seja para Web, Desktop ou Mobille.
                </p>
                <p class="profile-description">
                    ...
                    o emprego de algoritimos apropriados para cada aplicação, lógica, raciocínio, agilidade e claro,  muito café. 
                </p>                
                <p class="profile-description">
                    Também é muito importante manter o designer patner, pois devemos ter em mente a melhoria continua do sistema.
                </p>
            </div>
            <div class="span4 profile">
                <p class="profile-description">
                    Com o emprego das funções técnicas a serem renderizadas em um sistema computacional, um programador deve sempre ter em mente que quem irá usufruir 
                ...
                <p class="profile-description">
                  Estudo, dedicação e ser criterioso são atributos imprescindíveis para um programador.  
                </p>
            </div>
        </div>
    </div>
